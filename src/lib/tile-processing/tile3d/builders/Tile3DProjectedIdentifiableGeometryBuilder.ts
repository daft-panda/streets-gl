...
export default class Tile3DProjectedIdentifiableGeometryBuilder {
	...
	public getGeometry(): Tile3DIdentifiableProjectedGeometry {
		return {
			type: 'projected',
			zIndex: this.zIndex,
			...
			osmIdBuffer: new Uint32Array(this.arrays.osmId)
		};
	}
