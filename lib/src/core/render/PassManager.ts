...
import HostInterfaceManager, { MountedHostInterface } from '../HostInterfaceManager';
...
export default class PassManager {
	...
	public get hostInterface(): MountedHostInterface | null {
		return this.systemManager.getHostInterface();
	}
