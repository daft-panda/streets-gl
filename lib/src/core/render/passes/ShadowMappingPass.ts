...
import VehicleSystem from "~/core/systems/VehicleSystem";
import { AircraftPartType } from "~/core/vehicles/aircraft/Aircraft";
import Camera from "~/lib/core/Camera";
import Vec2 from "~/lib/math/Vec2";
import AbstractTexture2DArray from "~/lib/renderer/abstract-renderer/AbstractTexture2DArray";
import { Tile3DInstanceLODConfig, Tile3DInstanceType, InstanceStructure } from "~/lib/tile-processing/tile3d/features/Tile3DInstance";
import CSMCascadeCamera from "../CSMCascadeCamera";
import GenericInstanceDepthMaterialContainer from "../materials/GenericInstanceDepthMaterialContainer";
import ProjectedMeshDepthMaterialContainer from "../materials/ProjectedMeshDepthMaterialContainer";
import { InstanceTextureIdList } from "../textures/createInstanceTexture";
