...
export type AbstractSystemType = { new(): System };
...
export default class SystemManager {
	...
	private hostInterface: MountedHostInterface | null;
	...
	public addSystem(systemType: AbstractSystemType): System {
		if (this.systems.has(systemType)) {
			throw new Error('System already exists');
		}
		...
		system.postInit();
		this.runSystemReadyCallbacks(systemType, system);
	...
	public getHostInterface(): MountedHostInterface | null {
		return this.hostInterface;
	}

	public setHostInterface(hostInterface: MountedHostInterface) {
