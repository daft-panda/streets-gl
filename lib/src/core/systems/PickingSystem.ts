...
export default class PickingSystem extends System {
	...
	public postInit(): void {
		const canvas = this.systemManager.getHostInterface() ? 
		this.systemManager.getHostInterface().canvas : 
	...
	private onClick(): void {
		...
		if (this.hoveredObjectId !== 0) {
			...
			this.systemManager.getHostInterface().eventHandlers.activeFeatureChanged(type, id);
		}
	}
	...
	public clearSelection(): void {
		...
		this.systemManager.getHostInterface().eventHandlers.activeFeatureChanged(null);
	}
