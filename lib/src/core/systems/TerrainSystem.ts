...
import HeightReusedTileSourceFactory from "../terrain/tile-source/factory/HeightReusedTileSourceFactory";
import HeightTileSourceFactory from "../terrain/tile-source/factory/HeightTileSourceFactory";
import WaterTileSourceFactory from "../terrain/tile-source/factory/WaterTileSourceFactory";
import ControlsSystem, { NavigationMode } from "./ControlsSystem";
...
export default class TerrainSystem extends System {
	...
	public update(deltaTime: number): void {
		...
		this.terrainHeightProvider.update();
